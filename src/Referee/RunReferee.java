...
public class RunReferee {
	...
	public static void main(String[] args) {
		...
		Player player1 = (Player) new SimplePlayer("SimplePlayer2", 1, timeLimit);
		Player player2 = (Player) new CustomPlayer("CustomPlayer", 1, timeLimit);
